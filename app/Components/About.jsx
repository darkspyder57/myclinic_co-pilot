        ...
        <>
            <section id="about1" className="about">
                <div className="container">
                    ...
                    <div className="section-title" style={{color:"#2a2c39"}} data-aos="zoom-out">
                        <h3>Welcome to MyClinicCopilot</h3>
                    </div>
            ...
            <hr style={{ height: '5px', width: '95%', margin: 'auto' , border: 'none', color: 'yellow', backgroundColor: 'orange' }} data-aos="fade-up" />
